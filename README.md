...
CharityML is a fictitious organization, in which one has to make a prediction if a certain individual is likely to make a donation or not based on his/her annual income. There are a total of 13 different attributes and one target variable, income which is categorical dependent variable. 
